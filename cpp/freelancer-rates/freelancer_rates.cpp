...
#ifndef BILLING_PARAMS
    #define BILLING_PARAMS
    #define HOURS_PER_DAY 8
    #define BILLABLE_DAYS_PER_MONTH 22
#endif
...
int monthly_rate(double hourly_rate, double discount) {
    return ceil(apply_discount(daily_rate(hourly_rate) * BILLABLE_DAYS_PER_MONTH, discount));
}
